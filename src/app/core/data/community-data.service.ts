...
export class CommunityDataService extends ComColDataService<Community> {
   ...
   *    community list
   */
  getAdminAuthorizedCommunity(query: string, filterQuery: string, options: FindListOptions = {}, useCachedVersionIfAvailable = true, reRequestOnStale = true, ...linksToFollow: FollowLinkConfig<Community>[]): Observable<RemoteData<PaginatedList<Community>>> {
   ...
   *    community list
   */
  getAddAuthorizedCommunity(query: string, filterQuery: string, options: FindListOptions = {}, useCachedVersionIfAvailable = true, reRequestOnStale = true, ...linksToFollow: FollowLinkConfig<Community>[]): Observable<RemoteData<PaginatedList<Community>>> {
   ...
   *    community list
   */
  getEditAuthorizedCommunity(query: string, filterQuery: string, options: FindListOptions = {}, useCachedVersionIfAvailable = true, reRequestOnStale = true, ...linksToFollow: FollowLinkConfig<Community>[]): Observable<RemoteData<PaginatedList<Community>>> {
